...
class AthletesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create athlete" do
    assert_difference('Athlete.count') do
      post athletes_url, params: { athlete: { line_id: @athlete.line_id, line_name: @athlete.line_name, name: @athlete.name } }
    end
  ...
  test "should update athlete" do
    patch athlete_url(@athlete), params: { athlete: { line_id: @athlete.line_id, line_name: @athlete.line_name, name: @athlete.name } }
