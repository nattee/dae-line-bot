...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post stations_url, params: { station: { code: @station.code, course_id: @station.course_id, cutoff: @station.cutoff, distance: @station.distance, name: @station.name, shortname: @station.shortname } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { code: @station.code, course_id: @station.course_id, cutoff: @station.cutoff, distance: @station.distance, name: @station.name, shortname: @station.shortname } }
