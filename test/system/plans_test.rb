...
class PlansTest < ApplicationSystemTestCase
  ...
  test "creating a Plan" do
    ...
    fill_in "Margin minute", with: @plan.margin_minute
    fill_in "Pace", with: @plan.pace
    fill_in "Run", with: @plan.run_id
    fill_in "Station", with: @plan.station_id
    fill_in "Total minute", with: @plan.total_minute
    fill_in "Worldtime", with: @plan.worldtime
